...
```{r Labor Force Participation Rate in PR, message=FALSE, warning=FALSE}
...
```{r PR in Us Unemployment Visualization, message=FALSE, warning=FALSE}
...
```{r age_group_sql_2, message=FALSE,warning=FALSE}
...
```{r US pop LFPR by Age, message=FALSE, warning=FALSE}
...
```{r PR pop LFPR in PR by Age, message=FALSE, warning=FALSE}
...
```{r Total Age Group Visualizaing, message=FALSE, warning=FALSE}
...
```{r PR in PR Age Group Visualizaing, message=FALSE, warning=FALSE}
...
```{r PR Age Group Unemp Visualizaing, message=FALSE, warning=FALSE}
...
```{r Age Group Unemp Visualizaing, message=FALSE, warning=FALSE}
...
```{r PR Age Group Unemp Visualizaing in PR, message=FALSE, warning=FALSE}
